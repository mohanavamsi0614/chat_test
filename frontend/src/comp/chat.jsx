...
function Chat() {
    ...
    // useEffect( ()=>{
    //     axios.get(`https://test-0qaq.onrender.com/data/${room}`).then(
    //         (res)=>{
...
{messages.map((i,j)=>(
    <div key={j} className={localStorage.getItem("name")==i.user ? "border-white border  bg-white w-36 relative  p-1 rounded-2xl" :"border-white border bg-gray-500 w-36  right-1  p-1 rounded-2xl" }> 
    {console.log(i)}
